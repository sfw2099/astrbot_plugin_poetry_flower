...
def hub_unlock_achievement(context, uid: str, ach_id: str, name: str = "") -> bool:
    ...
    if hub is None:
        return False
    try:
        return bool(hub.unlock_achievement(uid, ach_id, plugin="astrbot_plugin_poetry_flower", name=name))
    except Exception:
        return False
...
def hub_set_progress(context, uid: str, ach_id: str, progress: int, name: str = "") -> bool:
    ...
    if hub is None:
        return False
    try:
        return bool(hub.set_achievement_progress(uid, ach_id, progress, plugin="astrbot_plugin_poetry_flower", name=name))
    except Exception:
        return False
...
def hub_record_plugin_use(context, uid: str, name: str = ""):
    ...
    if hub is None:
        return
    try:
        hub.record_plugin_use(uid, "astrbot_plugin_poetry_flower", name)
    except Exception:
        pass
...
def hub_register_manifest(context):
    ...
    if hub is None:
        return False
    try:
        hub.register_achievements("astrbot_plugin_poetry_flower", ACHIEVEMENTS)
        hub.register_items("astrbot_plugin_poetry_flower", ITEMS)
        return True
    except Exception:
        return False
